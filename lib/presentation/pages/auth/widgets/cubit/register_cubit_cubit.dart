...
class RegisterCubit extends Cubit<RegisterCubitState> {
  ...
  register({String? username, String? email, String? password, String? confirmPassword}) async {
    emit(RegisterCubitLoading());
    try{
      var res = await useCase.register(username: username, email: email, password: password, confirmPassword: confirmPassword);
